...
const PropertyDetails = ({ propertyDetails: { price, rentFrequency, rooms, baths, agency, area, isVerified, title, description, type, purpose, furnishingStatus, amenities, photos } }) => (
